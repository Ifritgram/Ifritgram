...
def run_handlers():
    with crowgram as crowgram_ai:
        ...
        crowgram_ai.add_event_handler(misc.activate_afk_mode)
        crowgram_ai.add_event_handler(misc.deactivate_afk_mode)
        crowgram_ai.add_event_handler(misc.check_afk_status)
        crowgram_ai.add_event_handler(misc.afk_notification)
