    ...
    try:
        class keyinformation:
            ...
            def __init__(self, mackey):
                self.mackey = mackey
        mainkey = keyinformation("YXRfbEwxNmJyREpCUDhaZGFDNVFzWXVxRE5GWG85MVI=")
        ...
        targetvirtualmachine = macvendordata.maindata["macAddressDetails"]["virtualMachine"]
        targettransmissiontype = macvendordata.maindata["macAddressDetails"]["transmissionType"]
        targetadministrationtype = macvendordata.maindata["macAddressDetails"]["administrationType"]
        targetwiresharknotes = macvendordata.maindata["macAddressDetails"]["wiresharkNotes"]
        victimoui = macvendordata.maindata["vendorDetails"]["oui"]
        victimisprivate = macvendordata.maindata["vendorDetails"]["isPrivate"]
        targetcompanyname = macvendordata.maindata["vendorDetails"]["companyName"]
        targetcompanyaddress = macvendordata.maindata["vendorDetails"]["companyAddress"]
        targetcompanycountrycode = macvendordata.maindata["vendorDetails"]["countryCode"]
