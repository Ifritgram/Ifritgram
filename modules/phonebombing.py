    ...
    try:
        ...
        while countsentsms < int(smsamount):
            ...
            if maindata["code"] == "200":
                countsentsms += 1
                await event.client.send_message(messagelocation, f"Successfully {countsentsms} SMS Sent To {targetphonenumber}")
                sleep(30)
            else:
                await event.client.send_message(messagelocation, "Message Not Sent")
